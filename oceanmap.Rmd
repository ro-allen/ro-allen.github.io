...
Download MODIS-Aqua satellite data from the [NASA ocean data web portal](https://oceandata.sci.gsfc.nasa.gov/MODIS-Aqua/Mapped/). The data downloaded for this tutorial is seasonal 4 km resolution chlorophyll-a data from the Boreal Summer of 2011. 
...
v(chl.360.crop, cbpos = "r", pal = vpal, zlim = c(0,1), cb.xlab = expression("Chlorophyll-a (mg m"^-3*")"), bwd = 0.01, grid = F, replace.na = F, Save = T, plotname = "sp_rmd_plot", fileformat = "png", width = 10, height = 5)
```
<center>
